...
import com.multipurposeapp.MessageChatActivity;
...
//        }
        ...
        holder.itemView.setOnClickListener(view -> {
            onItemClick.onItemCLick(user.getId(),view,user.getUsername());
        });


        holder.profile_image.setOnClickListener(view -> onItemClick.onItemCLick(user.getId(),view,user.getUsername()));
    }
